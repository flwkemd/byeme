...
%>
	...
	<div class="container">
		<div class="row">
			<div class="write">
			<form method="post" action="write.do" name="board_frm">
			...
			<tbody>
				...
				<tr>	
					<td><textarea type="text" class="form-control" placeholder="글 내용" name="bContent" maxlength="2048" style="height: 350px;"></textarea></td>
				</tr>
			</tbody>
			</table>
