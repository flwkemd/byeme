	...
	<div class="container">
			<div class="row">
				...
				<%
            		...
            		ArrayList<boardDto> searchBoard = boardDao.searchBoard(col, word, pageNumber);
            		for(int i=0; i<searchBoard.size(); i++){
				%>
				<tr>
					<td><%= searchBoard.get(i).getbId() %></td>
					<td><%= searchBoard.get(i).getuserId() %></td>
					<td>
						<a href="content_view.do?bId=<%=searchBoard.get(i).getbId()%>"><%= searchBoard.get(i).getbTitle() %></a>
					</td>
					<td><%= searchBoard.get(i).getbDate()%></td>
					<td><%= searchBoard.get(i).getbHit()%></td>
				</tr>
				<%
					}
				%>
