...
%>
	...
	<div class="container">
		<div class="row">
			<div class="write">
			<form method="post" action="modify.do?bId=<%= bId %>" name="board_frm">
			...
			<tbody>
				...
				<tr>	
					<td><input type="text" class="form-control" placeholder="글 내용" name="bContent" maxlength="2048" style="height: 350px;" value="<%= dto.getbContent() %>"></td>
				</tr>
			</tbody>
			</table>
				<input type="hidden" name="userId" value="<%=userId%>">
				<input type="button" class="btn btn-primary pull-right" onclick="boardConfirm()" value="수정">
			</form>
			</div>
		</div>
	</div>
