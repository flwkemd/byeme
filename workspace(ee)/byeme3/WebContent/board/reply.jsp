...
%>
	...
	<div class="container">
		<div class="row">
			<div class="write">
			<form method="post" action="reply.do?bId=<%=bId %>" name="board_frm">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				<tr>
					<th colspan="2" style="background-color: #eeeeee; text-align: center;">게시판 답변 양식</th>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>	
					<td><input type="text" class="form-control" placeholder="글 내용" name="bContent" maxlength="2048" style="height: 350px;"></td>
				</tr>
			</tbody>
			</table>
				<input type="hidden" name="userId" value="<%=userId%>">
				<input type="hidden" name="bGroup" value="<%=dto.getbId() %>">
				<input type="hidden" name="bStep" value="<%=dto.getbStep()%>">
				<input type="hidden" name="bIndent" value="<%=dto.getbIndent()%>">
				<input type="button" class="btn btn-primary pull-right" onclick="boardConfirm()" value="글쓰기">
			</form>
			</div>
		</div>
	</div>
